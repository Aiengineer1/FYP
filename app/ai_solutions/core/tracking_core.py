...
# --- Model paths ---
import os
DETECTION_MODEL_PATH = os.path.join(os.path.dirname(__file__), "..", "ml_models", "detection", "person_detect_yolov11.pt")
TRACKING_MODEL_PATH = os.path.join(os.path.dirname(__file__), "..", "ml_models", "segmentation", "yolo11n-seg.pt")
...
class ObjectMemory:
    ...
    def find_match(self, embedding):
        ...
        # Removed noisy debug message for no matches
