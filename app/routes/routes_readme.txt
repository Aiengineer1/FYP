Read file: app/routes/auth.py
Read file: app/routes/mall.py
I've now read the authentication and mall routes in detail. I will continue to read the remaining route files (`camera.py`, `analytics.py`, `customer.py`, `id_management.py`) to ensure a complete and accurate frontend integration document.
Read file: app/routes/camera.py
I've now read the camera routes in detail. I will continue to read the remaining route files (`analytics.py`, `customer.py`, `id_management.py`) to ensure a complete and accurate frontend integration document.
Read file: app/routes/analytics.py
I've now read the analytics routes in detail. I will continue to read the remaining route files (`customer.py`, `id_management.py`) to ensure a complete and accurate frontend integration document.
Read file: app/routes/customer.py
Read file: app/routes/id_management.py
I've now read all the route files in your backend. I have a complete understanding of all available endpoints, their parameters, and their intended usage.

I will now prepare a detailed, frontend-focused documentation for all routes, including:
- Endpoint paths
- Methods (GET/POST/PUT/DELETE)
- Required parameters/body
- Example usage
- What the frontend should expect and how to use each route

This will be organized for easy reference by your frontend team.
Here is a detailed, frontend-focused documentation for all your backend routes, organized by feature/module. This will help your frontend team understand how to integrate with your backend.
...
If you want this as a markdown file, or want more details/examples for any specific route, let me know!  
This doc will help your frontend team understand and integrate with your backend easily.